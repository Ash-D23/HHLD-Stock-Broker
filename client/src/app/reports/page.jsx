...
const Reports = () => {
       ...
       const getMarketData = async () => {
           const res = await axios.get('http://localhost:4000/getHistoricalData', {
            params: {
                symbol: stockSymbol
            }
           });
           ...
           <div>
               <div className="flex flex-col items-center bg-gray-200 justify-center h-screen">
                   <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-80">
                       <h2 className="text-2xl text-black font-semibold mb-4">Educosys Stock Broker App Reports</h2>
                       <input
